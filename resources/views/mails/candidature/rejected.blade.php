...
<head>
    <meta charset="utf-8">
    <title>Rejet de votre candidature — {{ $companyName ?? config('app.name') }}</title>
...
<body>
    <div class="card" role="article" aria-label="Information d'intérêt pour la candidature">
        <div class="header">
            <h1>Nous sommes désolé de vous annoncer que votre candidature n'a pas été retenue par le recruteur</h1>
        </div>

        <div class="body">
            <p class="muted">Bonjour {{ $applicantName ? e($applicantName) : 'Madame, Monsieur' }},</p>

            <p>Suite à votre candidature au poste de <strong>{{ $positionTitle ? e($positionTitle) : '—' }}, nous avons le regrèt de vous informer de son refus.</strong>.
                <br>Toute fois, nous restons convaincu que ce n'était juste pas la bonne opportunité.
                <br>Ne vous découragez pas et continuez de postuler aux nombreuses offres que nous mettons à votre disposition.
            </p>
            ...
            <div style="margin-top:16px;">
                <p>Nous vous remercions de votre confiance et serions ravis de traiter vos futures candidatures.</p>
