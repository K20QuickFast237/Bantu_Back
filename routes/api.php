...
use App\Http\Controllers\Acheteur\FavoriController as AcheteurFavoriController;
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::middleware('auth:api')->prefix('profile')->group(function () {
        Route::post('/particulier', [ParticulierProfileController::class, 'store']);
        Route::put('/particulier', [ParticulierProfileController::class, 'update']);
        
        Route::post('/acheteur', [ParticulierProfileController::class, 'registerAcheteur']);
        Route::post('/vendeur', [ProfessionnelProfileController::class, 'registerVendeur']);
...
Route::middleware(['auth:api'])->group(function () {
    ...
    Route::prefix('favoris')->group(function () {
        Route::get('/', [AcheteurFavoriController::class, 'index']);
        Route::post('/', [AcheteurFavoriController::class, 'store']);
        Route::delete('/{id}', [AcheteurFavoriController::class, 'destroy']);
    });
